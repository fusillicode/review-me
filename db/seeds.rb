...
user = User.create(first_name: 'John', last_name: 'Doe', email: 'johndoe@sample.com', password: '123456', password_confirmation: '123456')
(1..20).each do |i|
  user.posts.create!(title: "Lipsum Post #{i}", body: %{
